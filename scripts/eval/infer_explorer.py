...
Usage:
    ...
    python scripts/eval/infer_explorer.py --checkpoint checkpoints/explorer_run4/gnn_final.pt

    # Compare pure GNN vs heuristics (H=0.0 vs H=1.0)
    python scripts/eval/infer_explorer.py --checkpoint checkpoints/gnn/proof_step_pretrained.pt --compare

    # Test on post-1905 file specifically
    python scripts/eval/infer_explorer.py --checkpoint checkpoints/gnn/proof_step_pretrained.pt \\

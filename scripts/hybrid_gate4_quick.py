...
Usage: python scripts/hybrid_gate4_quick.py
"""
...
from scripts.eval_gnn_prover import build_lemma_index, normalize_expression, extract_conclusion
from scripts.eval_hybrid_retrieval import build_norm_index

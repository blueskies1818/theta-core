...
Usage:
    python scripts/build_dependency_graph.py                          # Full build
    python scripts/build_dependency_graph.py --max 10000              # Test build
    python scripts/build_dependency_graph.py --domain Analysis        # Domain subgraph
"""
...
def main():
    ...
    if not input_path.exists():
        ...
        print("Run scripts/prepare_data.py first to extract theorems.")
        sys.exit(1)

...
Usage:
    python scripts/bench_h2_scoring.py
    python scripts/bench_h2_scoring.py --checkpoint checkpoints/explorer_gate3_v4/gnn_final.pt
    python scripts/bench_h2_scoring.py --k-hops 5 --output data/h2_scoring_results_k5.json
"""

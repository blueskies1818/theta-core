...
Usage:
    python scripts/audit_purity.py [--data-dir data] [--graph-path data/graph]
"""
...
def audit_reward(reward_dir: Path, configs_dir: Path) -> list[str]:
    ...
    corr_path = Path("/home/blueman1818/Projects/theta-core/src/correspondence/reward_integration.py")
    if corr_path.exists():

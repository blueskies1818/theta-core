...
Usage:
    ...
    python scripts/training/train_hard_negative_contrastive.py --epochs 30 --batch-size 128

    # Train without hard negatives (InfoNCE only — like original)
    python scripts/training/train_hard_negative_contrastive.py --epochs 30 --no-hard-negatives
